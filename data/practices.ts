...
export const MANTRAS: Record<EmotionKey, string[]> = {
  anger: [
    ...
    'Мой гнев — сигнал, а не приговор.',
    'Я выбираю спокойствие вместо борьбы.',
  ],
  fear: [
    'Я в безопасности здесь и сейчас.',
    'Этот страх не больше меня.',
    'Я дышу, и тревога отпускает.',
  ],
  sadness: [
    'Это чувство — волна, и она пройдёт.',
    'Я позволяю себе грустить и отпускаю.',
    'Сквозь печаль я вижу свет.',
  ],
  disgust: [
    'Я разрешаю себе отстраниться и выдохнуть.',
    'Мне можно отстраниться от того, что не моё.',
    'Я возвращаю себе своё пространство.',
  ],
  anticipation: [
    'Я делаю один шаг за раз.',
    'Мне не нужно знать всё заранее.',
    'Я доверяю процессу.',
  ],
  joy: [
    'Я позволяю себе этот момент.',
    'Эта радость — моя, и я её держу.',
    'Я замечаю хорошее прямо сейчас.',
  ],
  trust: [
    'Я опираюсь на себя.',
  ...
  surprise: [
    'Я открыт тому, что приходит.',
    'Неожиданное — это дверь, а не стена.',
    'Я встречаю новое с любопытством.',
  ],
};
